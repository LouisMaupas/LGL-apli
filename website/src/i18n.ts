...
const resources = {
  en: { 
    translation: {
        ...
        "login.form.signup": "or Sign Up",
        "login.form.helper-email": "We do not sell or provide your information to third parties.",
        "login.form.error.wrongPassword": "Wrong password",
        "login.form.error.invalidEmail": "Wrong email",
        // REGISTER
        ...
        "register.form.confirmEmail": "confirm email address",
        ...
        "howToPlay": {
          "description": {
            "term1": "Duel of Reigns is a strategic card game played in two rounds. Each round consists of 12 duels, where two players confront each other by playing cards. The goal is to earn as many points as possible to become the winner of the game.",
            "term2": "Each player builds a",
            "term3": "deck",
            "term4": "of 24 cards, composed of 6 cards from 4",
            "term5": "different factions",
            "term6": ". Each card has a",
            "term7": "power",
            "term8": "and a",
            "term9": "value",
            "term10": "either normal or boosted when played during its reign. The cards belong to different factions such as humans, elves, orcs, and demons. During a duel, players play a card in turn. The card with the highest power wins the trick, and the values of both cards are added to the winner's score. Duels follow a specific sequence, with phases of activation, play, combat, and scoring. Players have",
            "term11": "gold coins (GC)",
            "term12": "that they can spend to include cards in their deck. Each player starts with 240 GC. The cost of the cards must be managed to build a balanced and effective deck. The game also features elements such as special effects and special cases that can influence the course of duels and rounds. At the end of the two rounds, the player with the highest score wins the game. It is a strategic game where deck composition, resource management, and tactical decision-making are essential to achieve victory.",
            "term13": "",
            "term14": "",
            "term15": "",
            "term16": "",
          ...
          "general": "General",
          "Rules": "Terms:",
          "game": "Game = both rounds.",
          "round": "Round = 12 duels.",
          "duel": "Duel: see the progress of a duel.",
          "power-desc": "Power = the value that determines which card wins the duel.",
          "value": "Value",
          "valueDesc": " = number of points that will be added to the winner's score of the duel.",
          "cost": "Cost: the number of gold coins to spend to include the card in the deck.",
          "goldCoin": "Gold Coin (GC)",
          "goldCoin-desc": " = currency used to buy cards to include them in the deck. Each player has 240 GC.",
          ...
          "cards": {
            "cards": "Cards",
            "link": "View all cards",
            "info": "Information about the cards:"
          },
          "power": "Power.",
          "powerDesc": "normal / a boosted power when its faction reigns.",
          "normalValue": "Normal value / a boosted value when its faction reigns.",
          ...
          "deckCostLimit": "Must cost a total of less than 240 GC.",
  ...
  fr: {
    translation: {
        ...
        // FIXME : this part should be sent by backend / from DB
        ...
        "login.form.signup": "ou s'inscrire",
        "login.form.helper-email": "Nous ne vendons ni ne fournissons vos informations à des tiers.",
        "login.form.error.wrongPassword": "Mauvais mot de passe",
        "login.form.error.invalidEmail": "Mauvais email",
        // REGISTER
        ...
        "register.form.confirmEmail": "confirmez votre adresse email",
        ...
        "howToPlay": {
            ...
            "cards": {
              "cards": "Cartes",
              "link": "Voir toutes les cartes",
              "info": "Les informations concernant les cartes :"
            },
            "power": "Une puissance.",
